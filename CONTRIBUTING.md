...
Each GCM component has its own CONTRIBUTING guide:

- [Monitoring](gcm/CONTRIBUTING.md)
- [Health Checks](gcm/CONTRIBUTING.md)
...
## License
By contributing to gcm, you agree that your contributions will be licensed
